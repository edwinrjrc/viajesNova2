...
public class ParametroSession implements ParametroRemote, ParametroLocal {
	...
	@Override
	public List<pe.com.logistica.bean.negocio.Parametro> listarParametros() throws SQLException {
	...
	public void registrarParametro(
			pe.com.logistica.bean.negocio.Parametro parametro) throws SQLException {
		parametroDao = new ParametroDaoImpl();
